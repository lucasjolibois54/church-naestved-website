...
function ValueSec() {
    return (
        ...
        "
      >
        <div className="w-full bg-light-green pt-10 pb-20 pr-10 text-right sm:w-2/6">
...
er en vigtig del af det vi står for.</h2>
        ...
        <div className="w-full bg-medium-green pt-10 pb-20 text-right pr-10 sm:w-2/6">
...
vi viser til andre
        ...
        <div className="w-full bg-dark-green pt-10 pb-20 pr-10 sm:w-2/6 text-right">
