    ...
    <div>
          ...
          <div class="py-12 px-6 max-w-xl lg:max-w-8xl lg:w-11/12">
            ...
            <div class="mt-8 ml-6">
              <a
                ...
                className="bg-dark-green px-4 py-2 md:font-semibold text-biege-text inline-flex items-center space-x-2 rounded"
              >
      ...
      <div class="py-12 max-w-xl lg:max-w-2xl lg:w-full lg:py-0 2xl:max-w-3xl">
        ...
        <p class="text-dark-text mt-12 mx-6 lg:mt-10 lg:pl-12 2xl:pr-28 2xl:mt-12">
          Som en del af vores nye koncept, er vi i samrbejde med vores kirke
          begyndt på at lave events hvorpå vores fokus er at skabe et
          fællesskab. Alle events er gratis, og vi holder alt fra musik events,
          mad, fredags hygge, rap gydstjenester og meget mere. Dette er ikke
